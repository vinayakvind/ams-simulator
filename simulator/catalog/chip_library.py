...
REUSABLE_IP_LIBRARY: dict[str, dict[str, Any]] = {
    ...
    "ring_oscillator": {
        ...
        "ports": ["VDD", "GND", "EN", "CLK_OUT", "FREQ_TRIM"],
        "aliases": ["osc", "ring_osc"],
    ...
    "pll": {
        ...
        "category": "sequencing",
        "generator": "pll",
        "ports": ["VDD", "GND", "REF_CLK", "FEEDBACK_CLK", "CLK_OUT", "LOCK_DETECT", "DIV_RATIO"],
        "aliases": ["pll_macro"],
    ...
    "voltage_ladder_dac": {
        ...
        "ports": [],
        "aliases": ["string_dac", "resistor_ladder"],
    ...
    "trim_circuit": {
        ...
        "ports": ["VDD", "GND", "TRIM_CODE", "VREF_TUNED"],
        "aliases": ["trim", "tuning_circuit"],
    ...
    "bias_generator": {
        ...
        "category": "bias",
        "generator": "bias_gen",
        "ports": ["VDD", "GND", "BIAS_OUT", "TRIM_CODE"],
        "aliases": ["bias", "self_bias"],
    ...
    "lvds_driver": {
        ...
        "ports": ["VDD", "VDD_IO", "GND", "LVDS_P", "LVDS_N", "SIGNAL_IN"],
        "aliases": ["lvds", "differential_driver"],
    ...
    "esd_protection": {
        ...
        "category": "interface",
        "generator": "esd_array",
        "ports": ["VDD", "VSS", "IO_RAIL"],
        "aliases": ["esd_clamp", "esd_diode"],
    ...
    "flash_memory": {
        ...
        "ports": ["clk", "rst_n", "addr", "din", "dout", "wr_en", "erase_en"],
        "aliases": ["flash", "nvm", "nonvolatile_memory"],
    ...
    "reset_generator": {
        ...
        "category": "sequencing",
        "generator": "reset_gen",
        "ports": ["VDD", "GND", "EXT_RST_N", "RST_N_OUT", "POR_N"],
        "aliases": ["reset_logic", "por_generator"],
    ...
    "boost_converter": {
        ...
        "ports": ["VIN", "VOUT", "GND", "EN", "FREQ_DIV"],
        "aliases": ["boost", "step_up_converter"],
    ...
    "current_reference": {
        ...
        "ports": ["VDD", "GND", "IREF_OUT", "TRIM_CODE", "EN"],
        "aliases": ["iref", "curent_source_ref", "bandgap_iref"],
    ...
    "frequency_detector": {
        ...
        "ports": ["CLK_IN", "VDD", "GND", "FREQ_VALID", "FREQ_HI_N", "CLK_DIV"],
        "aliases": ["freq_mon", "clock_detector"],
    ...
    "slew_rate_limiter": {
        ...
        "ports": ["VDD", "GND", "IN", "OUT", "SLEW_CTRL"],
        "aliases": ["slew_buf", "soft_start_buf"],
    ...
    "programmable_gain_amplifier": {
        ...
        "category": "sense",
        "generator": "pga",
        "ports": ["VDD", "GND", "VIN_P", "VIN_N", "VOUT", "GAIN_SEL", "VBIAS"],
        "aliases": ["pga", "variable_gain_amp"],
    ...
    "comparator_array": {
        ...
        "ports": ["VDD", "GND", "IN_P", "IN_N", "SEL", "OUT", "VREF_ARRAY", "HYSTERESIS"],
        "aliases": ["comp_mux", "window_comparator"],
    ...
    "rs485_transceiver": {
        ...
        "ports": ["VDD", "GND", "TXD", "RXD", "A", "B", "DE", "RE_N"],
        "aliases": ["rs485", "half_duplex_phy"],
    ...
    "pwm_controller": {
        ...
        "category": "sequencing",
        "generator": "pwm_gen",
        "ports": ["clk", "rst_n", "duty_code", "freq_sel", "pwm_out", "pwm_n_out"],
        "aliases": ["pwm", "pulse_width_mod"],
    ...
    "buffered_precision_dac": {
        ...
        "category": "converter",
        "generator": "buf_dac",
        "ports": ["VDD", "GND", "DIN", "VOUT", "VREF", "EN"],
        "aliases": ["buffered_dac", "precision_dac_with_buffer"],
    ...
    "lvds_receiver": {
        ...
        "aliases": ["lvds_rx", "differential_receiver"],
        ...
        "generator_params": {
            "data_rates": "155M to 3.2Gbps",
            "jitter_tolerance": "<200ps RMS",
            "propagation_delay": "<2ns max"
        },
        "example_config": {
        ...
        "integration_example": {
            "backplane_signaling": "Backplane differential signaling with impedance matching and AC coupling",
            "adc_interface": "High-speed ADC interface with clock recovery and data synchronization",
            "multi_channel": "Multi-channel differential arrays with phase alignment and skew matching"
        }
    },
    "ethernet_phy": {
        ...
        "category": "interface",
        "generator": "eth_phy",
        "ports": ["VDD", "VDD_IO", "GND", "RXD_P", "RXD_N", "TXD_P", "TXD_N", "MDI_P", "MDI_N", "CLK"],
        "aliases": ["ethernet", "eth_phy", "rmii_interface"],
    ...
    "profibus_transceiver": {
        ...
        "ports": ["VDD", "GND", "TXD", "RXD", "PROFIBUS_P", "PROFIBUS_N", "EN", "DE"],
        "aliases": ["profibus", "profibus_phy"],
    ...
    "canopen_controller": {
        ...
        "ports": ["clk", "rst_n", "txd", "rxd", "int_n", "sdo_mosi", "sdo_miso", "pdo_in", "pdo_out"],
        "aliases": ["canopen", "can_open_stack"],
    ...
    "isolated_gate_driver": {
        ...
        "ports": ["VDD", "VDD_ISO", "GND", "GND_ISO", "IN", "OUT", "OUT_N"],
        "aliases": ["gate_driver", "isolated_driver"],
...
VERIFICATION_IP_LIBRARY: dict[str, dict[str, Any]] = {
    ...
    "power_supply_vip": {
        ...
        "checks": ["ripple and noise", "PSRR, transient response", "regulation accuracy", "ramp rate"],
        "command": "python designs/framework/scripts/run_design_snapshot.py --design {design}",
    ...
    "adc_linearity_vip": {
        ...
        "checks": ["INL/DNL analysis", "code histogram", "missing codes", "monotonicity"],
        "command": "python designs/framework/scripts/run_design_snapshot.py --design {design}",
        "description": "Validates ADC linearity through INL/DNL computation and code transition analysis.",
    },
    "noise_performance_vip": {
        "name": "Noise Performance VIP",
        "protocol": "Signal integrity",
        "checks": ["SNR calculation", "THD analysis", "SFDR measurement", "noise floor"],
        "command": "python designs/framework/scripts/run_design_snapshot.py --design {design}",
    ...
    "emc_compliance_vip": {
        ...
        "checks": ["EMI immunity", "conducted emissions", "radiated immunity", "ESD margin"],
        "command": "python designs/framework/scripts/run_regression.py --design {design}",
    ...
    "voltage_regulation_vip": {
        ...
        "checks": ["DC regulation accuracy", "load transient response", "line regulation", "soft-start behavior"],
        "command": "python designs/framework/scripts/run_design_snapshot.py --design {design}",
    ...
    "frequency_accuracy_vip": {
        ...
        "checks": ["frequency tolerance", "temperature drift", "supply sensitivity", "long-term stability"],
        "command": "python designs/framework/scripts/run_design_snapshot.py --design {design}",
    ...
    "power_domain_isolation_vip": {
        ...
        "checks": ["cross-domain leakage", "isolation boundary integrity", "handshake synchronization", "metastability"],
        "command": "python designs/framework/scripts/run_regression.py --design {design}",
    ...
    "io_electrical_vip": {
        ...
        "checks": ["output drive strength", "input threshold margin", "leakage current", "output impedance"],
        "command": "python designs/framework/scripts/run_design_snapshot.py --design {design}",
    ...
    "temperature_corner_vip": {
        ...
        "checks": ["cold corner performance", "hot corner performance", "gradient effects", "thermal coupling"],
        "command": "python designs/framework/scripts/run_regression.py --design {design}",
...
DIGITAL_SUBSYSTEM_LIBRARY: dict[str, dict[str, Any]] = {
    ...
    "can_node_control_plane": {
        ...
        "blocks": ["can_controller", "spi_controller", "register_file", "interrupt_controller", "control_logic"],
    ...
    "i2c_sensor_interface": {
        ...
        "blocks": ["i2c_controller", "register_file", "interrupt_controller", "control_logic"],
    ...
    "uart_debug_interface": {
        ...
        "blocks": ["uart_controller", "register_file", "control_logic"],
    ...
    "frequency_monitoring_plane": {
        ...
        "blocks": ["frequency_detector", "control_logic", "register_file", "interrupt_controller"],
    ...
    "multi_rail_power_control": {
        ...
        "blocks": ["control_logic", "reset_generator", "register_file", "interrupt_controller", "temperature_sensor"],
    ...
    "pwm_motor_control_plane": {
        ...
        "blocks": ["pwm_controller", "register_file", "control_logic", "interrupt_controller"],
    ...
    "analog_conditioning_plane": {
        ...
        "blocks": ["programmable_gain_amplifier", "low_pass_filter", "comparator_array", "register_file", "control_logic"],
    ...
    "rs485_interface_plane": {
        ...
        "blocks": ["rs485_transceiver", "uart_controller", "register_file", "control_logic"],
...
CHIP_PROFILE_LIBRARY: dict[str, dict[str, Any]] = {
    ...
    "can_automotive_node": {
        ...
        "tags": ["automotive", "can", "mixed-signal", "reliability", "thermal-safe"],
        "blocks": ["can_transceiver", "can_controller", "temperature_sensor", "watchdog_timer", "interrupt_controller", "spi_controller", "register_file", "control_logic"],
        "vips": ["can_vip", "thermal_monitoring_vip", "spi_vip", "power_sequence_vip"],
        "digital_subsystems": ["can_node_control_plane", "thermal_management_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "multi_sensor_hub": {
        ...
        "tags": ["sensor-hub", "i2c", "multi-channel", "thermal", "mixed-signal"],
        "blocks": ["bandgap", "ldo_analog", "ldo_digital", "i2c_controller", "temperature_sensor", "sar_adc_top", "sigma_delta_adc_top", "register_file", "interrupt_controller", "control_logic", "low_pass_filter", "analog_multiplexer"],
        "vips": ["i2c_vip", "adc_transient_vip", "analog_snapshot_vip", "thermal_monitoring_vip", "spi_vip"],
        "digital_subsystems": ["i2c_sensor_interface", "thermal_management_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "debug_console_interface": {
        ...
        "tags": ["debug", "uart", "spi", "telemetry", "control-plane"],
        "blocks": ["uart_controller", "spi_controller", "register_file", "interrupt_controller", "control_logic"],
        "vips": ["uart_vip", "spi_vip", "digital_subsystem_vip"],
        "digital_subsystems": ["uart_debug_interface"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "analog_signal_conditioner": {
        ...
        "tags": ["analog", "conditioning", "precision", "measurement", "adc"],
        "blocks": ["bandgap", "precision_voltage_reference", "operational_amplifier", "low_pass_filter", "analog_multiplexer", "sar_adc_top", "current_mirror"],
        "vips": ["adc_transient_vip", "analog_snapshot_vip"],
        "digital_subsystems": ["converter_control_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "high_voltage_power_supply": {
        ...
        "tags": ["pmic", "hv", "power", "automotive", "protection"],
        "blocks": ["bandgap", "buck_converter", "charge_pump", "ldo_analog", "ldo_digital", "watchdog_timer", "temperature_sensor", "control_logic", "register_file"],
        "vips": ["power_sequence_vip", "thermal_monitoring_vip", "current_consumption_vip", "analog_snapshot_vip"],
        "digital_subsystems": ["thermal_management_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "audio_codec_asic": {
    ...
    "real_time_motor_controller": {
        ...
        "tags": ["motor", "pwm", "three-phase", "real-time", "industrial", "automotive"],
        "blocks": ["bandgap", "ldo_analog", "ldo_digital", "pwm_controller", "programmable_gain_amplifier", "comparator_array", "temperature_sensor", "watchdog_timer", "interrupt_controller", "spi_controller", "register_file", "control_logic"],
        "vips": ["power_sequence_vip", "thermal_monitoring_vip", "current_consumption_vip", "frequency_accuracy_vip"],
        "digital_subsystems": ["pwm_motor_control_plane", "thermal_management_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "isolated_rs485_gateway": {
        ...
        "tags": ["industrial", "rs485", "isolation", "gateway", "communication"],
        "blocks": ["bandgap", "ldo_analog", "ldo_digital", "rs485_transceiver", "uart_controller", "spi_controller", "register_file", "interrupt_controller", "control_logic"],
        "vips": ["uart_vip", "spi_vip", "emc_compliance_vip", "power_domain_isolation_vip"],
        "digital_subsystems": ["rs485_interface_plane", "test_control_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "precision_analog_frontend": {
        ...
        "tags": ["precision", "measurement", "instrumentation", "analog", "multi-channel"],
        "blocks": ["bandgap", "precision_voltage_reference", "current_reference", "programmable_gain_amplifier", "comparator_array", "low_pass_filter", "sar_adc_top", "trim_circuit", "register_file", "control_logic"],
        "vips": ["adc_transient_vip", "analog_snapshot_vip", "io_electrical_vip", "frequency_accuracy_vip"],
        "digital_subsystems": ["analog_conditioning_plane", "converter_control_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "iot_edge_hub": {
        "name": "IoT Edge Hub",
    ...
    "automotive_hvdc_pmic": {
        ...
        "tags": ["automotive", "power", "boost", "buck", "multi-rail", "hvdc"],
        "blocks": ["bandgap", "boost_converter", "buck_converter", "ldo_analog", "ldo_digital", "frequency_detector", "charge_pump", "temperature_sensor", "watchdog_timer", "interrupt_controller", "spi_controller", "register_file", "control_logic"],
        "vips": ["power_sequence_vip", "thermal_monitoring_vip", "current_consumption_vip", "frequency_accuracy_vip", "voltage_regulation_vip"],
        "digital_subsystems": ["multi_rail_power_control", "frequency_monitoring_plane", "thermal_management_plane"],
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "automotive_infotainment_soc": {
        ...
        "tags": ["automotive", "infotainment", "multimedia", "safety", "soc", "connectivity"],
        "blocks": ["bandgap", "ldo_analog", "ldo_digital", "i2s_audio_controller", "can_transceiver", "can_controller", "ethernet_phy", "temperature_sensor", "watchdog_timer", "interrupt_controller", "spi_controller", "uart_controller", "register_file", "control_logic"],
    ...
    "industrial_iot_gateway": {
        ...
        "tags": ["industrial", "iot", "gateway", "fieldbus", "security", "edge"],
        "blocks": ["bandgap", "ldo_analog", "ldo_digital", "profibus_transceiver", "canopen_controller", "ethernet_phy", "aes_accelerator", "sha_accelerator", "true_random_number_generator", "uart_controller", "spi_controller", "register_file", "interrupt_controller", "control_logic"],
    ...
    "isolated_power_supply_controller": {
        ...
        "tags": ["isolated", "power", "pmic", "industrial", "multi-rail", "safety"],
        "blocks": ["bandgap", "boost_converter", "buck_converter", "ldo_analog", "ldo_digital", "isolated_gate_driver", "charge_pump", "temperature_sensor", "frequency_detector", "watchdog_timer", "reset_generator", "spi_controller", "register_file", "interrupt_controller", "control_logic"],
    ...
    "ethernet_sensor_hub": {
        ...
        "tags": ["sensor", "hub", "ethernet", "precision", "measurement", "industrial"],
        "blocks": ["bandgap", "ldo_analog", "ldo_digital", "ethernet_phy", "i2c_controller", "spi_controller", "precision_voltage_reference", "operational_amplifier", "sar_adc_top", "low_pass_filter", "comparator_array", "uart_controller", "register_file", "interrupt_controller", "control_logic"],
    ...
    "safe_motor_drive_controller": {
        ...
        "tags": ["motor", "drive", "safety", "sil", "industrial", "diagnostics"],
        "blocks": ["bandgap", "ldo_analog", "ldo_digital", "pwm_controller", "programmable_gain_amplifier", "high_speed_comparator", "temperature_sensor", "watchdog_timer", "reset_generator", "interrupt_controller", "spi_controller", "register_file", "control_logic"],
