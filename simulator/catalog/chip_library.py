...
VERIFICATION_IP_LIBRARY: dict[str, dict[str, Any]] = {
    ...
    "ethernet_vip": {
        ...
        "checks": ["frame format", "CRC validation", "link detection", "collision detection", "MDI signaling"],
        "command": "python designs/framework/scripts/run_regression.py --design {design}",
        "description": "Validates Ethernet PHY compliance with IEEE 802.3 standards and frame integrity.",
    },
    "profibus_vip": {
        "name": "PROFIBUS VIP",
        "protocol": "PROFIBUS PA/DP",
        "checks": ["bit timing", "frame format", "addressing", "CRC validation", "collision handling"],
        "command": "python designs/framework/scripts/run_regression.py --design {design}",
        "description": "Validates PROFIBUS transceiver protocol compliance for industrial fieldbus networks.",
    },
    "canopen_vip": {
        "name": "CANopen VIP",
        "protocol": "CANopen",
        "checks": ["SDO transfer", "PDO mapping", "NMT state machine", "heartbeat", "emergency messages"],
        "command": "python designs/framework/scripts/run_regression.py --design {design}",
        "description": "Validates CANopen protocol stack including object dictionary access and state management.",
    },
    "clock_gating_vip": {
        "name": "Clock Gating VIP",
        "protocol": "Clock gating control",
        "checks": ["gating latency", "enable synchronization", "glitch immunity", "clock tree propagation"],
        "command": "python designs/framework/scripts/run_design_snapshot.py --design {design}",
        "description": "Validates clock gating cells for correct enable timing and glitch-free operation.",
    },
    "precision_dac_vip": {
...
DIGITAL_SUBSYSTEM_LIBRARY: dict[str, dict[str, Any]] = {
    ...
    "clock_gating_plane": {
        ...
        "description": "Integrated clock gating and domain control for multi-frequency clock generation and distribution.",
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "ethernet_control_plane": {
        ...
        "description": "Complete Ethernet PHY control and management interface subsystem for networked applications.",
        "technology_support": ["generic130", "generic65", "bcd180", "generic22"],
    },
    "safety_monitor_plane": {
        ...
        "description": "Safety-critical monitoring subsystem with watchdog, temperature, and system reset coordination.",
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
    "infotainment_control_plane": {
        ...
        "description": "Multimedia and human-machine interface subsystem with I2S audio, I2C, and UART support.",
        "technology_support": ["generic180", "generic130", "generic65", "bcd180"],
    },
...
CHIP_PROFILE_LIBRARY: dict[str, dict[str, Any]] = {
    ...
    "automotive_infotainment_soc": {
        ...
        "narrative": "This profile creates a complete automotive infotainment chip combining I2S audio interfaces, multi-protocol connectivity (CAN, Ethernet), safety monitoring, and robust power management for in-vehicle entertainment and navigation systems.",
    ...
    "industrial_iot_gateway": {
        ...
        "narrative": "This profile assembles a complete industrial IoT gateway from multiple protocol interfaces (PROFIBUS, CANopen, Ethernet), cryptographic security acceleration, and robust power management for distributed industrial control and data collection.",
    ...
    "isolated_power_supply_controller": {
        ...
        "narrative": "This profile creates a comprehensive isolated power controller combining multiple LDO rails with galvanic isolation, boost/buck conversion, high-side gate drivers, and power sequencing for industrial equipment requiring multiple isolated supplies.",
    ...
    "ethernet_sensor_hub": {
        ...
        "narrative": "This profile assembles a complete sensor aggregation and networking device combining Ethernet connectivity, multi-protocol sensor interfaces (I2C, SPI), precision analog front-ends, and data buffering for industrial process monitoring and control.",
